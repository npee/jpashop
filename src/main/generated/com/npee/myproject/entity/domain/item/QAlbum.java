...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = 728873171L;
    ...
    //inherited
    public final ListPath<com.npee.myproject.entity.domain.Category, com.npee.myproject.entity.domain.QCategory> categories = _super.categories;
